...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, gm=True, edim=2):
...
def ResNet50(edim=2, gm=True):
    return ResNet(Bottleneck, [3, 4, 6, 3], gm=gm, edim=edim)
